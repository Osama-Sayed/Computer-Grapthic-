...
int main()
{
	...
	/// 2.5- Drawing CoinSet ///
	/// ====================
	pOut->PrintMessage("2.5- Drawing (CoinSet) Test,  Click to continue");
	pIn->GetPointClicked(x,y);	//Wait for any click

	///TODO: Define 5 cell positions

	///TODO: Call Function DrawCoinSet of Class Ouput for each cell position defined in the previous steps

	pOut->PrintMessage("FINISHED - Drawing (CoinSet) Test,  Click to continue");
	pIn->GetPointClicked(x,y);	//Wait for any click
